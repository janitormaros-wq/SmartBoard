...
VITAJ SPÄŤ, Michal
Hardvérový vývojár (Hardware Developer)
...
Microsoft Teams
Úlohy práce
• Navrhni technickú schému zapojenia

• Otestuj funkčnosť jednotlivých komponentov a celého obvodu

• Zostav fyzické zapojenie obvodu podľa schémy

• Zefektívni zapojenie – optimalizuj rozmery, spotrebu energie a prepojenia medzi komponentmi

• Diagnostikuj a oprav chyby v hardvéri

• Spolupracuj s projektovým manažérom a softvérovým vývojárom

• Sleduj kvalitu výstupov a dodržiavanie technických špecifikácií

• Priprav technickú dokumentáciu k hardvéru
