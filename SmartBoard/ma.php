...
VITAJ SPÄŤ, Maroš
Softvérový vývojár (Software Developer)
...
Microsoft Teams
Úlohy práce
• Testuj kód a overuj jeho správnu funkčnosť

• Okomentuj celý kód pre lepšiu čitateľnosť a budúcu údržbu

• Odovzdaj konečný kód v upravenej a stabilnej verzii

• Odovzdaj konečný priečinok s projektom

• Spolupracuj s hardvérovým vývojárom a projektovým manažérom pri ladení funkcionality

• Sleduj dodržiavanie štandardov programovania a kvality kódu

• Optimalizuj kód pre efektívnosť a rýchlosť vykonávania

• Dokumentuj logiku programu a použité algoritmy
